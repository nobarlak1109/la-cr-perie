...
{
public:
    explicit FactoryController(FactoryModel* factory = nullptr)
        : factory(factory)
    {
    }
    ...
    void update(float deltaTime) override
    {
        ...
        factory->update(deltaTime * static_cast<float>(speed));
    }
    int getLostItems() const
{
    return factory ? factory->getLostItems() : 0;
}
